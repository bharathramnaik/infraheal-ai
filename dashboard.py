...
def create_dashboard(
    ...
    def _continuous_monitor():
        ...
        try:
            ...
            # Process each scenario inline with visible sub-steps
            scenario_list = list(scenarios.items())
            total_scenarios = len(scenario_list)
            summary_rows = ""
            total_anomalies = 0
            ...
            final_output = (
                ...
                f'<div style="color:#8b949e;font-size:0.72rem;margin-top:12px;text-align:right;">Report generated at {now}</div>'
                f'</div>'
            )
